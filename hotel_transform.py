...
def hotel_transform(input_data, output_data):
    with open(input_data, 'r') as input_file:
         df_test = pd.read_csv(input_file)
    
    cl_to_use_list = ['Property Id','City','Property Name','Primary Property Type - Self Selected',
    ...
    df_hotel_cleaned = df_hotel[cols]

    with open(output_data, 'w') as output_file:
        output_file = df_hotel_cleaned.to_csv(index=False)
